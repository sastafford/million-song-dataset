...
def get_artist_terms(h5,songidx=0):
    ...
    """
    output = ""
    term_freq = h5.root.metadata.artist_terms_freq[h5.root.metadata.songs.cols.idx_artist_terms[songidx]:]
    term_weight = h5.root.metadata.artist_terms_weight[h5.root.metadata.songs.cols.idx_artist_terms[songidx]:]
    if h5.root.metadata.songs.nrows == songidx + 1:
        terms = h5.root.metadata.artist_terms[h5.root.metadata.songs.cols.idx_artist_terms[songidx]:]
        j = 0
        for term in terms:
...
def get_artist_mbtags(h5,songidx=0):
    ...
    if h5.root.musicbrainz.songs.nrows == songidx + 1:
        tags = h5.root.musicbrainz.artist_mbtags[h5.root.musicbrainz.songs.cols.idx_artist_mbtags[songidx]:]
